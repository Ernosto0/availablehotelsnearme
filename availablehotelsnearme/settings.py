"""
Django settings for availablehotelsnearmeproject.
...
SECRET_KEY = 'django-insecure-ogu!&&_(#qut4un$$g81+-r+5u(m=v3sc73=(^=isgkb(ofq4s'
...
ROOT_URLCONF = 'availablehotelsnearme.urls'
...
WSGI_APPLICATION = 'availablehotelsnearme.wsgi.application'
